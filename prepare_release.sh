...
This release brings new insights to your mining metrics by tracking the P2Pool global network effort securely right on your Sentinel dashboard!

### 🌟 Features / Enhancements

- **P2Pool Global Network Effort Tracking**: See exactly how "lucky" the pool has been by visualizing the Real-Time Pool Effort generated by dividing active hashes by network difficulty dynamically within the Sentinel probe.
- **Average Network Effort Insights**: Sentinel now mathematically traverses the latest 10 historical blocks in the selected P2Pool chain, measuring hash discrepancies per block to identify the Average Pool Effort and rendering it securely within your local UI.

### Features

- **P2Pool Integration**: Monitor your P2Pool shares, payouts, and effort statistics
